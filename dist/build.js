...
System.register("vendor/xmlToJSON", [], function($__export) {
  "use strict";
  var __moduleName = "vendor/xmlToJSON";
  var XmlToJSON;
  return {
    setters: [],
    execute: function() {
      XmlToJSON = (function() {
        function XmlToJSON(options) {
          ...
          }, this.prefixMatch = new RegExp(/(?!xmlns)^.*:/), this.trimMatch = new RegExp(/^\s+|\s+$/g);
        }
        return ($traceurRuntime.createClass)(XmlToJSON, {
          ...
          parseXML: function(oXMLParent, opt) {
            ...
            if (oXMLParent.attributes && oXMLParent.attributes.length > 0) {
              ...
              for (nLength; nLength < oXMLParent.attributes.length; nLength++) {
                ...
                if (this.options.stripAttrPrefix) {
                  attribName = oAttrib.name.replace('jello', '');
                } else {
            ...
            if (oXMLParent.hasChildNodes()) {
              for (nItem = 0; nItem < oXMLParent.childNodes.length; nItem++) {
            ...
            if (sCollectedTxt) {
              if (this.options.grokText) {
                value = this.grokType(sCollectedTxt.replace(this.trimMatch, ''));
          ...
          xmlToString: function(xmlDoc) {
            var xmlString;
            try {
              xmlString = xmlDoc.xml ? xmlDoc.xml : (new XMLSerializer()).serializeToString(xmlDoc);
              return xmlString;
            } catch (err) {
              throw new Error(err);
            }
...
System.register("modules/convertRSStoJSON", ["npm:lodash@3.8.0", "vendor/xmlToJSON"], function($__export) {
  "use strict";
  var __moduleName = "modules/convertRSStoJSON";
  var _,
      XmlToJSON;
  function convertRSStoJSON(xml) {
    ...
    escapedXML = _.escape(xml);
    outputJSON = JSON.stringify(xmlConverter.parseString(escapedXML));
    return outputJSON;
  }
  return {
    setters: [function($__m) {
      ...
      XmlToJSON = $__m.default;
    }],
    execute: function() {
      $__export("convertRSStoJSON", convertRSStoJSON);
    }
  };
});

System.register("app/app", ["npm:lodash@3.8.0", "modules/bootstrap", "modules/convertRSStoJSON"], function($__export) {
  "use strict";
  ...
  return {
    setters: [function($__m) {
      ...
      convertRSStoJSON = $__m.convertRSStoJSON;
    }],
    execute: function() {
      console.log(convertRSStoJSON('<xml><a>It Works!</a></xml>'));
      initiateJS();
    }
  };
});
